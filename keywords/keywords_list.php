            ...
            <div class="row row-lg">
                <div class="col-sm-12 col-lg-12 col-md-10">
                    ...
                    <div class="example-wrap">
                        <h4 class="example-title">关键字列表</h4>
                        <div class="example">
                                    ...
                                    <?php if (!empty($keyword)){ ?>
                                        <?php foreach ($keyword as $key => $value): ?>
                                            <tr class="optimization">
                                                <td class="not"><a herf="javascript:void(0);">优化设置</a><input type="hidden" value="<?php echo $value['kid'] ?>"></td>
...
<script type="text/javascript">
    ...
    // 点击优化跳转
    $('.optimization .not a').click(function(event) {
