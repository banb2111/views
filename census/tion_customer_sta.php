             ...
             <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title clearfix">
                        <h5 class="pull-left">客户分类统计</h5>
                         <div class="control-group col-lg-2 col-md-4 ml2 hide">
                          <div class="controls">
                           <div class="input-prepend input-group">
                             <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span><input type="text" readonly="readonly" style="width: 200px" name="reservation2" id="reservation2" class="form-control" value="2016-7-14 - 2016-7-15" /> 
                           </div>
                          </div>
                        </div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="font-size:18px;font-weight: normal;">查询指定人员客户分类数据</h4>
            </div>
...
$(function(){
  ...
  function getNowFormatDate() {
    ...
    $("#chis_get_user").click(function(){
       ...
       // return;
        if (user_id) {
            ...
            // 加载该用户的客户数据
            tion_customer_sta(0,year,month,user_id,channel_id);
   ...
   $('#next_time').click(function(event) {
    ...
    tion_customer_sta(0,"<?php echo date('Y');?>","<?php echo date('m');?>");
    $("#chaxun").click(function(){
        ...
        if(parseInt(fuzeren) > 0){
            department = 0;
        }

        tion_customer_sta(department,year,month,fuzeren,channel_id);
    });
    ...
    function tion_customer_sta (department,year,month,fuzeren,channel_id){
        $.post('<?=base_url();?>index.php/statistical/ajax_customer_status',{"department":department,"year":year,"month":month,"fuzeren":fuzeren,"channel_id":channel_id},function(status) {
