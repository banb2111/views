...
$(function(){
    ...
    $("#chis_get_user").click(function(){
       ...
       // return;
        if (user_id) {
            ...
            // 加载该用户的客户数据
            follow_customer_sta(0,year,month,user_id,channel_id);
    ...
    follow_customer_sta(0,"<?php echo date('Y');?>","<?php echo date('m');?>");
    $("#chaxun").click(function(){
        ...
        follow_customer_sta(department,year,month,fuzeren,channel_id);
    });
...
function follow_customer_sta(department,year,month,fuzeren,channel_id){
    $.post("<?=base_url();?>index.php/statistical/follow_count",{"department":department,"year":year,"month":month,"fuzeren":fuzeren,'channel_id':channel_id},function(data){
