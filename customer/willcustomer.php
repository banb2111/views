            ...
            <div class="row row-lg">
                ...
                <div class="col-sm-12 col-lg-10 col-md-10">
                    ...
                    <div class="example-wrap">
                        <h4 class="example-title">重点客户</h4>
                        <div class="example">
...
//        var arr = [];
        ...
        $('.qianyue input').click(function(event) {
            ...
            var _url="<?php echo base_url(); ?>index.php/customer/menulist/will_customer?&sign_status="+temp+"&will_status=<?= $_GET['will_status'] ?>&status=<?=$_GET['status'] ?>&tag=<?php echo $_GET['tag']; ?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&sortType=<?=$_GET['sortType']?>&type=<?=$_GET['type']?>&sousuo_text=<?=$_GET['sousuo_text']?>&start_time=<?=$_GET['start_time']?>&end_time=<?=$_GET['end_time']?>&isPublic=<?=$_GET['isPublic'];?>&zhuguan=<?=$_GET['zhuguan']?>";
            // alert(_url);
            $.loadPage(_url);
        });
         // 重点客户右侧查询条件
        ...
        $('.bags li').click(function(event) {
            ...
            noCustomer ();
            var _url="<?php echo base_url(); ?>index.php/customer/menulist/will_customer?&tag="+temp+"&will_status=<?=$_GET['will_status']; ?>&sign_status=<?=$_GET['sign_status'] ?>&status=<?php echo $_GET['status']; ?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&sortType=<?=$_GET['sortType']?>&type=<?=$_GET['type']?>&sousuo_text=<?=$_GET['sousuo_text']?>&start_time=<?=$_GET['start_time']?>&end_time=<?=$_GET['end_time']?>&isPublic=<?=$_GET['isPublic'];?>&zhuguan=<?=$_GET['zhuguan']?>";
            $.loadPage(_url);
        });
...
<script>
    $(function(){
        ...
        $("#sort_lastContactDate").click(function(){
            var _url="<?php echo base_url(); ?>index.php/customer/menulist/will_customer?&sortType=1&will_status=<?=$_GET['will_status'] ?>&sign_status=<?=$_GET['sign_status'] ?>&tag=<?=$_GET['tag']?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&status=<?php echo $_GET['status']; ?>&type=<?=$_GET['type'];?>&sousuo_text=<?=$_GET['sousuo_text'];?>&start_time=<?=$_GET['start_time'];?>&end_time=<?=$_GET['end_time'];?>&isPublic=<?=$_GET['isPublic'];?>&zhuguan=<?=$_GET['zhuguan']?>";
            $.loadPage(_url);
        });
        $("#sort_Name").click(function(){
            var _url="<?php echo base_url(); ?>index.php/customer/menulist/will_customer?&sortType=2&will_status=<?=$_GET['will_status'] ?>&sign_status=<?=$_GET['sign_status'] ?>&tag=<?=$_GET['tag']?>&status=<?php echo $_GET['status']; ?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&type=<?=$_GET['type'];?>&sousuo_text=<?=$_GET['sousuo_text'];?>&start_time=<?=$_GET['start_time'];?>&end_time=<?=$_GET['end_time'];?>&isPublic=<?=$_GET['isPublic'];?>&zhuguan=<?=$_GET['zhuguan']?>";
            $.loadPage(_url);
        })
        $("#sort_CreateDate").click(function(){
            var _url="<?php echo base_url(); ?>index.php/customer/menulist/will_customer?&sortType=3&will_status=<?=$_GET['will_status'] ?>&sign_status=<?=$_GET['sign_status'] ?>&tag=<?=$_GET['tag']?>&status=<?php echo $_GET['status']; ?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&type=<?=$_GET['type'];?>&sousuo_text=<?=$_GET['sousuo_text'];?>&start_time=<?=$_GET['start_time'];?>&end_time=<?=$_GET['end_time'];?>&isPublic=<?=$_GET['isPublic'];?>&zhuguan=<?=$_GET['zhuguan']?>";
            $.loadPage(_url);
        });
        ...
        $("#sousuo").click(function(){
            ...
            var _url= "<?php echo base_url(); ?>index.php/customer/menulist/will_customer?&type="+type+"&will_status=<?=$_GET['will_status'] ?>&sign_status=<?=$_GET['sign_status'] ?>&sousuo_text="+sousuo_text+"&status=<?php echo $_GET['status']; ?>&tag=<?=$_GET['tag'];?>&start_time=<?=$_GET['start_time'];?>&end_time=<?=$_GET['end_time'];?>&linkType=<?=$_GET['linkType'];?>&linkDay=<?=$_GET['linkDay'];?>&sortType=<?=$_GET['sortType']?>&isPublic=<?=$_GET['isPublic'];?>&zhuguan=<?=$_GET['zhuguan']?>";
            $.loadPage(_url);
        });
           ...
           var user_id=$('input[name="user_id"]:checked').val();
            if (user_id) {
                $.post("<?=base_url();?>index.php/customer/appoint_sale",{"cus_id":cus_id,"user_id":user_id},function(){
                    ...
                    var _url="<?php echo base_url(); ?>index.php/customer/menulist/will_customer";
                    $.loadPage(_url);
                })
            }else{
